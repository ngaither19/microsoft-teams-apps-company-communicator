...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Send.Func.Test
{
    ...
    public class NotificationServiceTest
    {
        ...
        public async Task UpdateSentNotification_Status_FaultedAndRetrying_Test()
        {
            ...
            // Act
            Func<Task> task = async () => await notificationService.UpdateSentNotification(this.notificationId, string.Empty, this.recipientId, this.totalNumberOfSendThrottles, SentNotificationDataEntity.FaultedAndRetryingStatusCode, string.Empty, string.Empty);
        ...
        public async Task UpdateSentNotification_Status_Created_Test()
        {
            ...
            // Act
            Func<Task> task = async () => await notificationService.UpdateSentNotification(this.notificationId, string.Empty, this.recipientId, this.totalNumberOfSendThrottles, (int)HttpStatusCode.Created, string.Empty, string.Empty);
        ...
        public async Task UpdateSentNotification_Status_TooManyRequest_Test()
        {
            ...
            // Act
            Func<Task> task = async () => await notificationService.UpdateSentNotification(this.notificationId, string.Empty, this.recipientId, this.totalNumberOfSendThrottles, (int)HttpStatusCode.TooManyRequests, string.Empty, string.Empty);
        ...
        public async Task UpdateSentNotification_Status_NotFound_Test()
        {
            ...
            // Act
            Func<Task> task = async () => await notificationService.UpdateSentNotification(this.notificationId, string.Empty, this.recipientId, this.totalNumberOfSendThrottles, (int)HttpStatusCode.NotFound, string.Empty, string.Empty);
        ...
        public async Task UpdateSentNotification_Status_Failed_Test()
        {
            ...
            // Act
            Func<Task> task = async () => await notificationService.UpdateSentNotification(this.notificationId, string.Empty, this.recipientId, this.totalNumberOfSendThrottles, 11, string.Empty, string.Empty);
